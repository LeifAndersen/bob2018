...
(define the-logo
  (with-cache (cachefile "the-logo.rktd")
    (λ () (bitmap (mk-logo 1000 #:parens? #f)))))

(define the-plain-logo
  (with-cache (cachefile "the-plain-logo.rktd")
    (λ () (bitmap (mk-logo 1000 #:parens? #f #:text? #f)))))
